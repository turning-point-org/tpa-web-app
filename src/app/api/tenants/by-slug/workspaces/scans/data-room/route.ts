...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/tenants/by-slug/workspaces/scans/data-room error:", error);
    return NextResponse.json(
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/tenants/by-slug/workspaces/scans/data-room error:", error);
    return NextResponse.json(
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    console.error("PATCH /api/tenants/by-slug/workspaces/scans/data-room error:", error);
    return NextResponse.json(
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error("DELETE /api/tenants/by-slug/workspaces/scans/data-room error:", error);
    return NextResponse.json(
