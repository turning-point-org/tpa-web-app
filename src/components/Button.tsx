...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = "inline-flex items-center justify-center border shadow-sm text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer disabled:cursor-not-allowed";
  ...
  const variantClasses = {
    ...
    secondary: "border-[#5319A5] text-[#5319A5] bg-white hover:bg-white focus:ring-[#5319A5] disabled:border-gray-300 disabled:text-gray-400 disabled:bg-gray-50",
    danger: "border-transparent text-white bg-red-600 hover:bg-red-700 focus:ring-red-500 disabled:bg-red-600/50",
    "danger-secondary": "border-red-600 text-red-600 bg-transparent hover:bg-white focus:ring-red-500 disabled:border-gray-300 disabled:text-gray-400 disabled:bg-gray-50"
  };
